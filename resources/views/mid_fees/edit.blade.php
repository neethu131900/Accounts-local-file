<x-app-layout>
    ...
    <div class="card card-default">
        ...
        <!-- /.card-header -->
        <form action="/feesupdate/{{$MidFees->id}}" method="POST">
            @csrf
            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control @if($errors->has('mid_list_id')) is-invalid @endif" name="mid_list_id" id="mid_list_id" style="width: 100%;">
                                ...
                                <option value="{{ $value->id }}" {{ ($MidFees->mid_list_id ==$value->id)?'selected':'' }}>{{ $value->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @if($errors->has('transaction_fee')) is-invalid @endif" id="transaction_fee" name="transaction_fee" value="{{$MidFees->transaction_fee }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @if($errors->has('timezone')) is-invalid @endif" name="timezone" id="timezone" style="width: 100%;">
                                ...
                                <option value="{{ $value->utc_offset }}" {{ ($MidFees->timezone ==$value->utc_offset)?'selected':'' }}>{{ $value->time_zone }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @if($errors->has('format_type_id')) is-invalid @endif" name="format_type_id" id="format_type_id" style="width: 100%;">
                                ...
                                <option value="{{ $value->id }}" {{ ($MidFees->format_type_id ==$value->id)?'selected':'' }}>{{ $value->type }}</option>
                                @endforeach
                            </select>
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-4 col-md-4">
                                    ...
                                    <select class="form-control @if($errors->has('settlement_currency')) is-invalid @endif" name="settlement_currency" id="settlement_currency" style="width: 100%;">
                                        ...
                                        <option value="{{ $value->code }}" {{ ($MidFees->settlement_currency ==$value->code)?'selected':'' }}>{{ $value->code }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-12 col-lg-4 col-md-4">
                                    ...
                                    <input type="text" class="form-control @if($errors->has('settlement_fee')) is-invalid @endif" id="settlement_fee" name="settlement_fee" value="{{ $MidFees->settlement_fee }}">
                                ...
                                <div class="col-12 col-lg-4 col-md-4">
                                    ...
                                    <select class="form-control @if($errors->has('settlement_fee_type')) is-invalid @endif" name="settlement_fee_type" id="settlement_fee_type" style="width: 100%;">
                                        ...
                                        <option value="{{ $value->type }}" {{ ($value->type == $MidFees->settlement_fee_type)?'selected':'' }}>{{ $value->type }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group mb-0">
                                <div class="row p-3 pb-4">
                                    <div class="col-12 col-lg-3 col-md-3">
                                        <label>Tax</label>
                                        <input type="text" class="form-control @if($errors->has('tax')) is-invalid @endif" id="tax" name="tax" value="{{ $MidFees->tax }}">
                                        @if($errors->has('tax'))
                                    ...
                                    <div class="col-12 col-lg-3 col-md-3">
                                        ...
                                        <select class="form-control @if($errors->has('tax_type')) is-invalid @endif" name="tax_type" id="tax_type" style="width: 100%;">
                                            ...
                                            @foreach ($feesType as $value)
                                            <option value="{{ $value->type }}" {{ ($value->type ==$MidFees->tax_type)?'selected':'' }}>{{ $value->type }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-12 col-lg-3 col-md-3">
                                        ...
                                        <input type="text" class="form-control @if($errors->has('refund_fee')) is-invalid @endif" id="refund_fee" name="refund_fee" value="{{ $MidFees->refund_fee }}">
                                    ...
                                    <div class="col-12 col-lg-3 col-md-3">
                                        ...
                                        <select class="form-control @if($errors->has('refund_fee_type')) is-invalid @endif" name="refund_fee_type" id="refund_fee_type" style="width: 100%;">
                                            ...
                                            @foreach ($feesType as $value)
                                            <option value="{{ $value->type }}" {{ ($value->type ==$MidFees->refund_fee_type)?'selected':'' }}>{{ $value->type }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="form-group mb-0">
                                <div class="row p-3 pb-4">
                                    <div class="col-12 col-lg-3 col-md-3">
                                        ...
                                        <input type="text" class="form-control @if($errors->has('pre_arbitration_fee')) is-invalid @endif" id="pre_arbitration_fee" name="pre_arbitration_fee" value="{{ $MidFees->pre_arbitration_fee }}">
                                    ...
                                    <div class="col-12 col-lg-3 col-md-3">
                                        ...
                                        <select class="form-control @if($errors->has('pre_arbitration_type')) is-invalid @endif" name="pre_arbitration_type" id="pre_arbitration_type" style="width: 100%;">
                                            ...
                                            @foreach ($feesType as $value)
                                            <option value="{{ $value->type }}" {{ ($value->type == $MidFees->pre_arbitration_type)?'selected':'' }}>{{ $value->type }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-12 col-lg-3 col-md-3">
                                        ...
                                        <input type="text" class="form-control @if($errors->has('retrievals_fee')) is-invalid @endif" id="retrievals_fee" name="retrievals_fee" value="{{ $MidFees->retrievals_fee }}">
                                    ...
                                    <div class="col-12 col-lg-3 col-md-3">
                                        ...
                                        <select class="form-control @if($errors->has('retrievals_type')) is-invalid @endif" name="retrievals_type" id="retrievals_type" style="width: 100%;">
                                            ...
                                            @foreach ($feesType as $value)
                                            <option value="{{ $value->type }}" {{ ($value->type ==$MidFees->retrievals_type)?'selected':'' }}>{{ $value->type }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="form-group mb-0">
                                <div class="row p-3 pb-4">
                                    <div class="col-12 col-lg-3 col-md-3">
                                        ...
                                        <input type="text" class="form-control @if($errors->has('mirco_mdr')) is-invalid @endif" id="mirco_mdr" name="mirco_mdr" value="{{$MidFees->mirco_mdr }}">
                                    ...
                                    <div class="col-12 col-lg-3 col-md-3">
                                        ...
                                        <select class="form-control @if($errors->has('mirco_mdr_type')) is-invalid @endif" name="mirco_mdr_type" id="mirco_mdr_type" style="width: 100%;">
                                            ...
                                            @foreach ($feesType as $value)
                                            <option value="{{ $value->type }}" {{ ($value->type == $MidFees->mirco_mdr_type)?'selected':'' }}>{{ $value->type }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-12 col-lg-3 col-md-3">
                                        ...
                                        <input type="text" class="form-control @if($errors->has('monthly_fee')) is-invalid @endif" id="monthly_fee" name="monthly_fee" value="{{ $MidFees->monthly_fee }}">
                                    ...
                                    <div class="col-12 col-lg-3 col-md-3">
                                        ...
                                        <select class="form-control @if($errors->has('monthly_fee_type')) is-invalid @endif" name="monthly_fee_type" id="monthly_fee_type" style="width: 100%;">
                                            ...
                                            @foreach ($feesType as $value)
                                            <option value="{{ $value->type }}" {{ ($value->type ==$MidFees->monthly_fee_type)?'selected':'' }}>{{ $value->type }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="form-group mb-0">
                                <div class="row p-3 pb-4">
                                    <div class="col-12 col-lg-3 col-md-3">
                                        ...
                                        <input type="text" class="form-control @if($errors->has('fraud_monitoring_fee')) is-invalid @endif" id="fraud_monitoring_fee" name="fraud_monitoring_fee" value="{{ $MidFees->fraud_monitoring_fee }}">
                                    ...
                                    <div class="col-12 col-lg-3 col-md-3">
                                        ...
                                        <select class="form-control @if($errors->has('fraud_monitoring_fee_type')) is-invalid @endif" name="fraud_monitoring_fee_type" id="fraud_monitoring_fee_type" style="width: 100%;">
                                            ...
                                            @foreach ($feesType as $value)
                                            <option value="{{ $value->type }}" {{ ($value->type ==$MidFees->fraud_monitoring_fee_type)?'selected':'' }}>{{ $value->type }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-12 col-lg-3 col-md-3">
                                        ...
                                        <input type="text" class="form-control @if($errors->has('authorisation_fee')) is-invalid @endif" id="authorisation_fee" name="authorisation_fee" value="{{ $MidFees->authorisation_fee }}">
                                    ...
                                    <div class="col-12 col-lg-3 col-md-3">
                                        ...
                                        <select class="form-control @if($errors->has('authorisation_fee_type')) is-invalid @endif" name="authorisation_fee_type" id="authorisation_fee_type" style="width: 100%;">
                                            ...
                                            @foreach ($feesType as $value)
                                            <option value="{{ $value->type }}" {{ ($value->type ==$MidFees->authorisation_fee_type)?'selected':'' }}>{{ $value->type }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="form-group mb-0">
                                <div class="row p-3 pb-4">
                                    <div class="col-12 col-lg-3 col-md-3">
                                        ...
                                        <input type="text" class="form-control @if($errors->has('declined_fee')) is-invalid @endif" id="declined_fee" name="declined_fee" value="{{ $MidFees->declined_fee }}">
                                    ...
                                    <div class="col-12 col-lg-3 col-md-3">
                                        ...
                                        <select class="form-control @if($errors->has('declined_fee_type')) is-invalid @endif" name="declined_fee_type" id="declined_fee_type" style="width: 100%;">
                                            ...
                                            @foreach ($feesType as $value)
                                            <option value="{{ $value->type }}" {{ ($value->type ==$MidFees->declined_fee_type)?'selected':'' }}>{{ $value->type }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-12 col-lg-3 col-md-3">
                                        ...
                                        <input type="text" class="form-control @if($errors->has('chargeback_fee')) is-invalid @endif" id="chargeback_fee" name="chargeback_fee" value="{{ $MidFees->chargeback_fee }}">
                                    ...
                                    <div class="col-12 col-lg-3 col-md-3">
                                        ...
                                        <select class="form-control @if($errors->has('chargeback_fee_type')) is-invalid @endif" name="chargeback_fee_type" id="chargeback_fee_type" style="width: 100%;">
                                            ...
                                            @foreach ($feesType as $value)
                                            <option value="{{ $value->type }}" {{ ($value->type ==$MidFees->chargeback_fee_type)?'selected':'' }}>{{ $value->type }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="form-group mb-0">
                                <div class="row p-3 pb-4">
                                    <div class="col-12 col-lg-3 col-md-3">
                                        ...
                                        <input type="text" class="form-control @if($errors->has('representment_fee')) is-invalid @endif" id="representment_fee" name="representment_fee" value="{{ $MidFees->representment_fee }}">
                                    ...
                                    <div class="col-12 col-lg-3 col-md-3">
                                        ...
                                        <select class="form-control @if($errors->has('representment_type')) is-invalid @endif" name="representment_type" id="representment_type" style="width: 100%;">
                                            ...
                                            @foreach ($feesType as $value)
                                            <option value="{{ $value->type }}" {{ ($value->type ==$MidFees->representment_type)?'selected':'' }}>{{ $value->type }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-12 col-lg-3 col-md-3">
                                        <label>Mdr</label>
                                        <input type="text" class="form-control @if($errors->has('mdr')) is-invalid @endif" id="mdr" name="mdr" value="{{ $MidFees->mdr }}">
                                        @if($errors->has('mdr'))
                                    ...
                                    <div class="col-12 col-lg-3 col-md-3">
                                        ...
                                        <select class="form-control @if($errors->has('mdr_type')) is-invalid @endif" name="mdr_type" id="mdr_type" style="width: 100%;">
                                            ...
                                            @foreach ($feesType as $value)
                                            <option value="{{ $value->type }}" {{ ($value->type ==$MidFees->mdr_type)?'selected':'' }}>{{ $value->type }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="form-group mb-0">
                                <div class="row p-3 pb-4">
                                    <div class="col-12 col-lg-3 col-md-3">
                                        ...
                                        <input type="text" class="form-control @if($errors->has('setup_fee')) is-invalid @endif" id="setup_fee" name="setup_fee" value="{{ $MidFees->setup_fee }}">
                                    ...
                                    <div class="col-12 col-lg-3 col-md-3">
                                        ...
                                        <select class="form-control @if($errors->has('setup_fee_type')) is-invalid @endif" name="setup_fee_type" id="setup_fee_type" style="width: 100%;">
                                            ...
                                            @foreach ($feesType as $value)
                                            <option value="{{ $value->type }}" {{ ($value->type ==$MidFees->setup_fee_type)?'selected':'' }}>{{ $value->type }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-12 col-lg-3 col-md-3">
                                        ...
                                        <input type="text" class="form-control @if($errors->has('annual_fee')) is-invalid @endif" id="annual_fee" name="annual_fee" value="{{ $MidFees->annual_fee }}">
                                    ...
                                    <div class="col-12 col-lg-3 col-md-3">
                                        ...
                                        <select class="form-control @if($errors->has('annual_fee_type')) is-invalid @endif" name="annual_fee_type" id="annual_fee_type" style="width: 100%;">
                                            ...
                                            @foreach ($feesType as $value)
                                            <option value="{{ $value->type }}" {{ ($value->type ==$MidFees->annual_fee_type)?'selected':'' }}>{{ $value->type }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="form-group mb-0">
                                <div class="row p-3 pb-4">
                                    <div class="col-12 col-lg-3 col-md-3">
                                        ...
                                        <input type="text" class="form-control @if($errors->has('settlement_transfer_fee')) is-invalid @endif" id="settlement_transfer_fee" name="settlement_transfer_fee" value="{{ $MidFees->settlement_transfer_fee }}">
                                    ...
                                    <div class="col-12 col-lg-3 col-md-3">
                                        ...
                                        <select class="form-control @if($errors->has('settlement_transfer_fee_type')) is-invalid @endif" name="settlement_transfer_fee_type" id="settlement_transfer_fee_type" style="width: 100%;">
                                            ...
                                            @foreach ($feesType as $value)
                                            <option value="{{ $value->type }}" {{ ($value->type ==$MidFees->settlement_transfer_fee_type)?'selected':'' }}>{{ $value->type }}</option>
                                            @endforeach
                                        </select>
